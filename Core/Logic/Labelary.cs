...
namespace Core.Logic
{
    public class Labelary(string content)
    {
        ...
        {
            var context = new IdeDbContext(settings.SqlConnection);
        ...
        private void ReplaceVar(string key, SqlParameter codigoParam, IdeDbContext context)
        {
        ...
        {
            var dbContext = new IdeDbContext(settings.SqlConnection);
            ...
            while (endIdx > 0)
            {
                ...
                if (startIdx > 0)
                {
                    ...
                    else
                    {
                        ...
                        _error.AppendLine($"Variable [@{key}@] es dessconocida.");
                    }
                }
                endIdx = _content.LastIndexOf("@]", startIdx);
            }
